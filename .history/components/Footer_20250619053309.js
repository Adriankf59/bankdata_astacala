        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/activities" className="text-sm text-gray-400 hover:text-red-500 transition-colors">
                  Activities
                </Link>
              </li>
              <li>
                <Link href="/rescue-history" className="text-sm text-gray-400 hover:text-red-500 transition-colors">
                  Rescue History
                </Link>
              </li>
              <li>
                <Link href="/map" className="text-sm text-gray-400 hover:text-red-500 transition-colors">
                  Map
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/join-us" className="text-sm text-gray-400 hover:text-red-500 transition-colors">
                  Join Us
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="text-sm text-gray-400 hover:text-red-500 transition-colors">
                  Privacy Policy
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:info@astacala.org" className="hover:text-red-500 transition-colors">
                  info@astacala.org
                </a>
              </li>
              <li className="flex items-start gap-2">
                <i className="fas fa-phone mt-0.5"></i>
                <a href="tel:+622112345678" className="hover:text-red-500 transition-colors">
                  +62 21 1234 5678
                </a>
              </li>
              <li className="flex items-start gap-2">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="text-gray-400 hover:text-red-500 transition-colors duration-200 text-lg"
                aria-label="Facebook"
              >
              ...
              <a
                href="https://youtube.com/@astacala"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-red-500 transition-colors duration-200 text-lg"
                aria-label="YouTube"
