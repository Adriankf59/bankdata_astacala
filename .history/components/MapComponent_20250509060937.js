            ...
            <div style="color: white; background-color: rgba(0,0,0,0.7); padding: 8px; border-radius: 4px; border-left: 3px solid ${color};">
              ...
              <div style="margin-top: 10px; font-size: 14px; line-height: 1.5;">
                <div style="display: flex; justify-content: space-between; margin-bottom: 4px;">
                  ...
                  <span style="color: white;">${feature.properties.karakterLorong || 'Tidak tersedia'}</span>
                </div>
                <div style="display: flex; justify-content: space-between; margin-bottom: 4px;">
                  <span style="font-weight: bold; color: #ffcc00;">Total Kedalaman:</span>
                  <span style="color: white;">${feature.properties.totalKedalaman ? feature.properties.totalKedalaman + ' m' : 'Tidak tersedia'}</span>
                </div>
                <div style="display: flex; justify-content: space-between; margin-bottom: 4px;">
                  <span style="font-weight: bold; color: #ffcc00;">Total Panjang:</span>
                  <span style="color: white;">${feature.properties.totalPanjang ? feature.properties.totalPanjang + ' m' : 'Tidak tersedia'}</span>
                </div>
              </div>
            </div>
          `;
