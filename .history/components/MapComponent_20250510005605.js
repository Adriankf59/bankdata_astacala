...
const MapComponent = ({ cavingData = [], cavingAstPoints = [], rockClimbingPoints = [], issDataPoints = [] }) => {
  ...
  const [activeFilters, setActiveFilters] = useState({
    ...
    paralayang: true,
    caving: true,
    astacalaOnly: false // New filter to show only Astacala data
  });
  ...
  const handleFilterChange = (division) => {
    ...
    if (division === 'all') {
      // Toggle all filters together (except astacalaOnly)
      ...
      // Toggle just the astacalaOnly filter
  ...
  const applyFiltersToMap = (filters) => {
    ...
    // Apply Astacala-only filter if enabled
  ...
  const addActivityPoints = (mapInstance) => {
    // Combine all data points, termasuk data ISS
    const allPoints = [
      ...activitiesPoints,
      ...cavingData,
      ...cavingAstPoints,
      ...rockClimbingPoints,
      ...issDataPoints // Menambahkan data ISS
    ];
    ...
    if (!mapInstance.getSource('activities-points')) {
        ...
        data: {
          ...
          features: allPoints.map(p => ({
            ...
            properties: { 
              ...
              // Include cave-specific properties
              ...
              // Include rock climbing-specific properties
              ketinggian: p.ketinggian || null,
              
              // Include ISS data specific properties
      ...
      mapInstance.on('click', 'points-layer', (e) => {
        ...
        // Data source labels, termasuk ISS data
        const sourceLabels = {
          astacala: 'Data Kegiatan Astacala',
          external: 'Data Eksternal',
          static: 'Data Statis',
          iss_data: 'Data ISS Karst', // Menambahkan label untuk data ISS
        ...
        if (feature.properties.division === 'caving') {
          ...
          // Add properties based on source
          if (feature.properties.source === 'iss_data') {
            // Format untuk data ISS
            popupContent += `
              <tr>
                <td style="font-weight: bold; color: #ffcc00; padding-right: 10px; width: 130px;">Deskripsi:</td>
                <td style="color: white;">${feature.properties.description || 'Tidak ada deskripsi'}</td>
              </tr>
              <tr>
                <td style="font-weight: bold; color: #ffcc00; padding-right: 10px; width: 130px;">Sumber Data:</td>
                <td style="color: white;">${feature.properties.sumberData || 'Tidak tersedia'}</td>
              </tr>
              <tr>
                <td style="font-weight: bold; color: #ffcc00; padding-right: 10px; width: 130px;">Jenis Potensi:</td>
                <td style="color: white;">${feature.properties.jenisPotensiKarst || 'Tidak tersedia'}</td>
              </tr>
              <tr>
                <td style="font-weight: bold; color: #ffcc00; padding-right: 10px; width: 130px;">Tipe Gua:</td>
                <td style="color: white;">${feature.properties.typeGua || 'Tidak tersedia'}</td>
              </tr>
              <tr>
                <td style="font-weight: bold; color: #ffcc00; padding-right: 10px; width: 130px;">Status Pemetaan:</td>
                <td style="color: white;">${feature.properties.statusPemetaanGua || 'Tidak tersedia'}</td>
              </tr>`;
            ...
            popupContent += `
              ...
              <tr>
                <td style="font-weight: bold; color: #ffcc00; padding-right: 10px; width: 130px;">Kegiatan:</td>
                <td style="color: white;">${feature.properties.kegiatan || 'Tidak tersedia'}</td>
              </tr>
              <tr>
                <td style="font-weight: bold; color: #ffcc00; padding-right: 10px; width: 130px;">Waktu Kegiatan:</td>
                <td style="color: white;">${feature.properties.waktuKegiatan || 'Tidak tersedia'}</td>
              </tr>
              <tr>
                <td style="font-weight: bold; color: #ffcc00; padding-right: 10px; width: 130px;">Lokasi:</td>
                <td style="color: white;">${feature.properties.kota || 'Tidak tersedia'}, ${feature.properties.provinsi || ''}</td>
              </tr>
              <tr>
                <td style="font-weight: bold; color: #ffcc00; padding-right: 10px; width: 130px;">Kedalaman:</td>
                <td style="color: white;">${feature.properties.kedalaman ? feature.properties.kedalaman + ' m' : 'Tidak tersedia'}</td>
              </tr>
              <tr>
            ...
            // Add ROP link if available
            if (feature.properties.linkRop) {
              popupContent += `
                <tr>
                  <td style="font-weight: bold; color: #ffcc00; padding-right: 10px; width: 130px;">ROP:</td>
                  <td style="color: white;"><a href="${feature.properties.linkRop}" target="_blank" style="color: #ffcc00; text-decoration: underline;">Lihat ROP</a></td>
                </tr>`;
            }
          } else {
            // External caves data format
            popupContent += `
              <tr>
                <td style="font-weight: bold; color: #ffcc00; padding-right: 10px; width: 130px;">Karakter Lorong:</td>
                <td style="color: white;">${feature.properties.karakterLorong || 'Tidak tersedia'}</td>
          ...
          popupContent = `
            <div style="color: white; background-color: rgba(0,0,0,0.7); padding: 8px; border-radius: 4px; border-left: 3px solid ${color};">
              ...
              <div style="margin-top: 10px; font-size: 14px; line-height: 1.5;">
                <table style="width: 100%; border-collapse: collapse;">
                  <tr>
                    <td style="font-weight: bold; color: #33ff33; padding-right: 10px; width: 130px;">Deskripsi:</td>
                    <td style="color: white;">${feature.properties.description || 'Tidak ada deskripsi'}</td>
                  </tr>
                  <tr>
                    <td style="font-weight: bold; color: #33ff33; padding-right: 10px; width: 130px;">Kegiatan:</td>
                    <td style="color: white;">${feature.properties.kegiatan || 'Tidak tersedia'}</td>
                  </tr>
                  <tr>
                    <td style="font-weight: bold; color: #33ff33; padding-right: 10px; width: 130px;">Waktu Kegiatan:</td>
                    <td style="color: white;">${feature.properties.waktuKegiatan || 'Tidak tersedia'}</td>
                  </tr>
                  <tr>
                    <td style="font-weight: bold; color: #33ff33; padding-right: 10px; width: 130px;">Lokasi:</td>
                    <td style="color: white;">${feature.properties.kota || 'Tidak tersedia'}, ${feature.properties.provinsi || ''}</td>
                  </tr>
                  <tr>
                    <td style="font-weight: bold; color: #33ff33; padding-right: 10px; width: 130px;">Ketinggian:</td>
                    <td style="color: white;">${feature.properties.ketinggian ? feature.properties.ketinggian + ' m' : 'Tidak tersedia'}</td>
                  </tr>`;
          ...
          if (feature.properties.linkRop) {
            popupContent += `
              <tr>
                <td style="font-weight: bold; color: #33ff33; padding-right: 10px; width: 130px;">ROP:</td>
                <td style="color: white;"><a href="${feature.properties.linkRop}" target="_blank" style="color: #33ff33; text-decoration: underline;">Lihat ROP</a></td>
              </tr>`;
          }
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <span style={{ color: 'white', fontSize: 11 }}>Divisi Caving</span>
          </div>
        </div>
      </div>
