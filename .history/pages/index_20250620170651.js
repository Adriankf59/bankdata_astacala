          ...
          <div className="max-w-7xl mx-auto">
            <div className="relative rounded-lg sm:rounded-xl lg:rounded-2xl shadow-lg overflow-hidden border border-gray-800 backdrop-blur-sm">
              ...
              <div className="relative z-20 px-6 py-12 sm:px-8 sm:py-16 md:px-10 md:py-20 lg:p-20 flex flex-col gap-4 text-white">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 sm:mb-4 leading-tight text-center sm:text-left">
                  Selamat Datang di Bank Data Astacala
                </h1>
                <p className="text-base sm:text-lg md:text-xl mb-4 sm:mb-6 text-gray-300 max-w-3xl leading-relaxed text-center sm:text-left mx-auto sm:mx-0">
                ...
                {/* Button Container with center alignment on mobile */}
                <div className="flex justify-center sm:justify-start">
                  <Link 
                    href="/map" 
                    className="inline-flex items-center bg-red-600 text-white px-4 py-2.5 sm:px-6 sm:py-3 rounded-lg font-semibold hover:bg-red-700 transition-all duration-300 group focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-black"
                  >
