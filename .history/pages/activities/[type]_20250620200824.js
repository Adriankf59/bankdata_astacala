...
const activitiesData = {
  ...
  diksar: {
    ...
    table: {
      columns: [
        { key: 'program', label: 'Program Pelatihan' },
        { key: 'durasi', label: 'Durasi' },
        { key: 'materi', label: 'Materi' },
      ],
      rows: [
        { program: 'Orientasi Dasar', durasi: '3 Hari', materi: 'Pengenalan organisasi, sejarah, dan nilai-nilai Astacala' },
        { program: 'Survival Training', durasi: '5 Hari', materi: 'Teknik bertahan hidup, navigasi, dan P3K' },
        { program: 'Leadership Camp', durasi: '4 Hari', materi: 'Kepemimpinan, kerjasama tim, dan problem solving' },
        { program: 'Ekspedisi Akhir', durasi: '7 Hari', materi: 'Penerapan seluruh materi dalam ekspedisi nyata' },
      ],
    },
  },
};
