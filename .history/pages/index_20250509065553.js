  ...
  return (
    <>
      ...
      <main className="bg-black min-h-screen flex flex-col justify-between">
        {/* Hero Section */}
        <section className="max-w-7xl mx-auto mt-10 mb-12 p-10 rounded-2xl bg-gray-900 text-white shadow-lg flex flex-col gap-4 border border-gray-800">
          <h1 className="text-5xl md:text-6xl font-bold mb-4">Selamat Datang di Bank Data Astacala</h1>
          <p className="text-lg md:text-xl mb-6 text-gray-300">Platform ini menyediakan informasi lengkap tentang kegiatan alam bebas dan penyelamatan yang dilakukan oleh Astacala. Jelajahi berbagai destinasi dan kegiatan menarik untuk pengalaman yang tak terlupakan.</p>
