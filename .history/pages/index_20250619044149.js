  ...
  return (
    <>
      ...
      <main className="bg-black min-h-screen flex flex-col justify-between">
        ...
        <section className="relative w-full px-4 sm:px-6 lg:px-8 mt-6 sm:mt-8 lg:mt-10 mb-8 sm:mb-10 lg:mb-12">
          <div className="max-w-7xl mx-auto">
            <div className="relative rounded-lg sm:rounded-xl lg:rounded-2xl shadow-lg overflow-hidden border border-gray-800">
